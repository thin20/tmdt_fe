...
export default {
  ...
  methods: {
    ...
    acceptPurchase (billId) {
      // TODO: call api update purchase status of user, then call api get list bill detail
    ...
    getListBillDetail (indexActive) {
      ...
      console.log(params)
      // TODO: call api get list bill detail
      this.listBill = [
        {
          id: 1,
          user: {
            id: 1,
            image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFCzxivJXCZk0Kk8HsHujTO3Olx0ngytPrWw&usqp=CAU',
            firstName: 'Thin',
            lastName: '01'
          },
          status: 2,

  ...
  actions: {
    GetListBillBySeller: ({ commit, dispatch }) => {
      ...
      return new Promise((resolve, reject) => {
        dispatch('SetListBillBySeller', listBillBySeller)
        dispatch('SetListProductInCart')
        resolve(listBillBySeller)
      })
    },
    ...
    ChangeQuantityProductInCart: ({ dispatch, state }, params) => {
      const { idBill, quantity } = params
      return new Promise((resolve, reject) => {
        // TODO call api change quantity product in cart
        const newList = _.cloneDeep(state.listBillBySeller)
        ...
        dispatch('SetListBillBySeller', newList)
        dispatch('SetListProductInCart')
        resolve(newList)
      })
    },
    RemoveProductsInCart: ({ dispatch, state }, listBillId) => {
      // TODO call api remove list product in cart
      return new Promise((resolve, reject) => {
        console.log('list billIds remove: ', listBillId)
        resolve(listBillId)
      })
    },

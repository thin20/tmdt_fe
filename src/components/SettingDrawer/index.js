import '@ant-design-vue/pro-layout/es/components/SettingDrawer/index.less'
...
import BlockCheckbox from '@ant-design-vue/pro-layout/es/components/SettingDrawer/BlockCheckbox'
import ThemeColor from '@ant-design-vue/pro-layout/es/components/SettingDrawer/ThemeColor'
import LayoutSetting, { renderLayoutSettingItem } from '@ant-design-vue/pro-layout/es/components/SettingDrawer/LayoutChange'
// import { updateTheme, updateColorWeak } from '@ant-design-vue/pro-layout/es/utils/dynamicTheme'
import { updateColorWeak } from '@ant-design-vue/pro-layout/es/utils/dynamicTheme'
...
export var settings = {
  ...
  // PropTypes.oneOf(['Fluid', 'Fixed']).def('Fluid')
